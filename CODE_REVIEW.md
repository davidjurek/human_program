...
### 2. `DateFormatter` rebuilt inside SwiftUI bodies (~12 sites) — 🟡 Partial
...
### 4. The four planning editors duplicate each other — 🟡 Partial
...
### 6. The DSKit migration is applied screen-by-screen — 🟡 In progress
...
### 8. Per-render O(n) / O(n²) recomputation in data-heavy screens — 🟡 Mostly fixed
...
### 9. Magic-string sentinels and brittle matching — 🟡 Partial
...
**Priority:** Low · **Sensitivity:** Medium · **Status:** ⬜ Open
...
**Priority:** Low · **Sensitivity:** Low · **Status:** ⬜ Open
...
**Priority:** Low · **Sensitivity:** None · **Status:** ⬜ Open
